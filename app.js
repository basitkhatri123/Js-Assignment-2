...
var joining= firstName.concat(lastName);

return joining

}

document.write(tellName()+"<br>");


function add(){

    var firstValue=+prompt("ENTER FIRST VALUE FOR ADDITION:");
    var secondValue=+prompt("ENTER 2nd VALUE FOR ADDITION:");
    var final=firstValue+secondValue;
    document.write("Result of addition is :"+ final+" "+"<br>");
...
var resullt=square(6);
document.write(resullt+"<br>");





function factorial(nmber){
    let answer = 1;
    if (nmber == 0 || nmber == 1){
      return answer;
    }else{
      for(var i = nmber; i >= 1; i--){
        answer = answer * i;
      }
      return answer;
    }  
  ...
  let nmber = 4;
  answer = factorial(nmber)
  document.write("The factorial of " + nmber + " is " + answer+"<br>");



function counting(start,ending){
...
var hyp=calcHypotenus(7,8);
document.write(hyp+"<br>");




function areaRect(widht, height){

    return widht*height;
}
var area=areaRect(4,5);
...
function ReverseString() { 
    ...
    var str=prompt("enter word for palindrom checck:")
    var reversed= str.split('').reverse().join('');
    if(reversed===str){
        document.write("Word is palindrom");
    }
    else{
        document.write("Word is not palindrom")
    }
 }
 ReverseString();
